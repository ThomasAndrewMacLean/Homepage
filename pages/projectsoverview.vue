<template>
    <section class="container">
        <div class="div-wrap">
            ...
            <project-thumb v-bind:class="{ 'hide': project.hide}" class="thumbs" v-for="project in projects"
                :key="project.id" :title="project.title" :excerpt="project.description"
            ...
            return context.app.$storyapi
                .get('cdn/stories', {
                    version: process.env.NODE_ENV == 'production' ?
                        'published' :
                        'draft',
                    starts_with: 'projects',per_page: 100
